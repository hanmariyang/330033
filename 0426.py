...
font_path = '/Users/jeong-yula/Desktop/streamlit/NanumGothic.ttf'
...
def main():
    ...
    st.set_page_config(page_title='채용공고추천시스템',layout='wide')
    ...
    with tab1:   
        ...
        if st.session_state.state=="추천시작":
            ...
            ax1.set_title(f'{company_name} 기업 평가 지표')
            ax1.set_xlabel('')
            ax1.set_ylabel('기업 평가')
            ax1.set_ylim(0, 100) 
